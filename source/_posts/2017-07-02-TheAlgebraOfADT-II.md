...
如果你学习过微积分，你也许记得许多函数都可以按照 [泰勒级数](http://en.wikipedia.org/wiki/Taylor_series) 进行展开。我们可以 [问一问 Wolfram Alpha](http://www.wolframalpha.com/input/?i=Series%5B+1%2F%281-a%29+%5D+at+a+%3D+0) $1/(1-a)$ 的泰勒级数是什么，然后它会告诉我们：
